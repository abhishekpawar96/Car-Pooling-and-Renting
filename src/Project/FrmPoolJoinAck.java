...
public class FrmPoolJoinAck extends javax.swing.JFrame {

 
    public FrmPoolJoinAck() {
        initComponents();
    }
    ...
    private void formWindowGainedFocus(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowGainedFocus
        ...
        curId.trim();
       FrmPoolJoin f5 = new FrmPoolJoin();
      String u = f5.getUnique();
        Connect c=new Connect();
        DBCollection dbc=c.connectPool();
      
        BasicDBObject bdb=new BasicDBObject("unique",u);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmPoolJoinAck.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmPoolJoinAck().setVisible(true);
            }
        });
    }
